        ...
        <section className="writingPage">
            ...
            <section>
                <article className="writingArticle" ref={artAnRef} id="1">
                    ...
                    Groensteen, T. (2007). Why are Comics Still in Search of Cultural Legitimization? In A. Magnussen & H. Christiansen (Eds.), Comics and Culture: Analytical and Theoretical Approaches to Comics (pp. 29-41). Museum Tusculanum Press.</p> <p className="reference">
                    Micchelli, T. and Carrier, D. (2020) The Work of Art in the Age of the Internet, Hyperallergic. Available at: http://hyperallergic.com/563938/the-work-of-art-in-the-age-of-the-internet/ (Accessed: 26 April 2024).</p> <p className="reference">
                    Tate (no date) Internet Art, Tate. Available at: https://www.tate.org.uk/art/art-terms/i/internet-art (Accessed: 26 April 2024).</p> <p className="reference">
